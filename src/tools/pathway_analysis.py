...
if __name__ == "__main__":
    test_file = "/home/share/huadjyin/home/liushiqiang/Projects/genomix-agent/output/test_l3_stratified_5pct/test_l3_stratified_5pct_annotated.h5ad"
    method_now = "ssGSEA"          # 想换方法直接改这里
    os.makedirs(settings.OUTPUT_DIR, exist_ok=True)

    results = pathway_analysis(method=method_now,
