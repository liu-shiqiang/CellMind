...
# ==== 修改为你的数据库 zip ====
CELLPHONEDB = "/home/share/huadjyin/home/zhangzilin/genomix-agent/data/cellphonedb_db/cellphonedb.zip"
...
class CellphoneDBArgs(BaseModel):
    ...
    celltype_column: str = Field(default="celltype_l4", description="AnnData.obs 中的细胞类型列名")
...
def run_cellphonedb_core(
    ...
    celltype_column: str = "celltype_l4",
...
if __name__ == "__main__":
    try:
        args = CellphoneDBArgs(
            file_path="/home/share/huadjyin/home/zhangzilin/genomix-agent/data/test_file/test_l3_stratified_5pct_annotated.h5ad",
            work_dir="/home/share/huadjyin/home/zhangzilin/genomix-agent/output/cell_communication_analysis",
